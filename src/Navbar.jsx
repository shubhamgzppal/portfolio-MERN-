const Navbar = ({ sidebarOpen, setSidebarOpen, activeSection }) => {
  return (
    <>
      {/* Desktop Navbar - only visible on extra-large screens (xl) */}
      <nav className="hidden xl:flex fixed top-0 left-0 right-0 z-40 bg-primary/90 dark:bg-gray-900/90 backdrop-blur-lg shadow-card transition-transform duration-300 translate-y-0">
