...
// Assets served from public/assets - use URL paths (do not import binary files)
const portfolioImage = '/assets/Portfolio sceenshot.png';
const ecommerceImage = '/assets/E commerce screenshot.png';
const shubhamAIImage = '/assets/Shubham AI screenshot.png';
const shubhamBlogImage = '/assets/Shubham Blog screenshot.png';
              ...
              {projects.map((project, idx) => (
                <motion.div 
                  ...
                  style={{
                    ...
                    boxShadow: '0 16px 40px rgba(0,0,0,0.18), 0 1.5px 8px rgba(0,0,0,0.10)',
                  }}
                  whileHover={{
                    rotateY: 8,
                    rotateX: 4,
                ...
                >
                  ...
                  >
                    <motion.img 
                      ...
                      whileHover={{ scale: 1.12, rotateY: 6, rotateX: 2 }}
                      transition={{ type: "spring", stiffness: 300 }}
                      style={{
                        boxShadow: '0 8px 24px rgba(0,255,247,0.18), 0 1.5px 8px rgba(0,0,0,0.10)',
                        transform: 'translateZ(24px)'
                      }}
                    />
                  </div>
                  <div className="p-6 transform-gpu group-hover:translate-y-[-5px] transition-transform duration-300"
                    style={{
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center mt-4">
                      <motion.a 
                        href={project.link}
                        className="text-sm text-secondary hover:text-tertiary transition-colors flex items-center gap-1 font-semibold drop-shadow"
                        whileHover={{ x: 5 }}
                        whileTap={{ scale: 0.95 }}
                      >
                        Live Demo
